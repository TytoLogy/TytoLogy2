function [data, datainfo] = TytoSpan_readdat2(datafile)
%------------------------------------------------------------------------
% [data, datainfo] = TytoSpan_readdat2.m(varargin)
%------------------------------------------------------------------------
% 
% Script for reading HPSearch2a/b binary file. 
%
%------------------------------------------------------------------------
%  Output arguments:
...
% Adopted for TytoSpan (TytoSpan_readdat2): Oct 2013 by GA (w/ minor debugging)
%------------------------------------------------------------------------
...
if isempty(datafile)
    [datafile, datapath] = uigetfile('*.dat2','Select HPSearch2 binary data file to read');
    if datafile == 0
...
% show reps and trials
%disp(sprintf('rep=%d, trials=%d, total=%d',nreps, ntrials, nstims)); 
...
%-------------------------
readfooter = 1;  % flag for reading footer
