function [ outhandles, outflag ] = HPSearch2c_TDTopen(config, varargin)
%------------------------------------------------------------------------
%[ outhandles, outflag ] = HPSearch2c_TDTopen(config, varargin)
%------------------------------------------------------------------------
% 
...
% Adopted for HPSearch2a (HPSearch2a_TDTopen): Aug 2012 by GA
% Adopted for HPSearch2b (HPSearch2b_TDTopen): Nov 2012 by GA
% Adopted for HPSearch2c (HPSearch2c_TDTopen): Jan 2015 by GA 
...
if TDTINIT
    ...
    titleStr = 'HPSearch2c: TDTINIT error';
