function [ outhandles, outflag ] = HPSearch2c_TDTclose(config, indev, outdev, zBUS, PA5L, PA5R)
%------------------------------------------------------------------------
%[ outhandles, outflag ] = HPSearch2c_TDTclose(config, indev, outdev, zBUS, PA5L, PA5R)
%------------------------------------------------------------------------
% 
...
% Adopted for HPSearch2a (HPSearch2a_TDTclose): Aug 2012 by GA
% Adopted for HPSearch2b (HPSearch2b_TDTclose): Nov 2012 by GA
% Adopted for HPSearch2c (HPSearch2c_TDTclose): Jan 2015 by GA 
