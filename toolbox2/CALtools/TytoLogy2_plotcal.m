function TytoLogy2_plotcal(flagL, dataL, flagR, dataR)
%------------------------------------------------------------------------
% TytoLogy2_plotcal.m
%------------------------------------------------------------------------
%
...
%   ashida@umd.edu
%------------------------------------------------------------------------
% Original Version (HPSearch2_plotcal): March 2012 by SJS
% Generalized Version (TytoLogy2_loadcal): May 2012 by GA  
%------------------------------------------------------------------------

% open figure window and set figure title 
figure;
set(gcf, 'name', 'calibration data');
...
% if both channels are on, then adjust X and Y ranges 
if flagL && flagR
