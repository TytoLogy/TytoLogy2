function outcaldata = TytoLogy2_mergecal(LeftOn, RightOn, caldataL, caldataR)
%------------------------------------------------------------------------
% outcaldata = TytoLogy2_mergecal(LeftOn, RightOn, caldataL, caldataR)
%------------------------------------------------------------------------
% 
...
%   ashida@umd.edu
%------------------------------------------------------------------------
% Original Version (HPSearch2_mergecal): November 2011 by GA
